...
import { varcTopics } from "../data/varcLinks";
import { varcTheory } from "../data/varcAndQarTheory";
...
export default function VARCPreparation() {
  ...
  // Progress updates when user solves VARC questions
  // Not just by visiting the page

  if (selectedTheory && selectedSubtopic) {
    const theory = varcTheory.find(t => t.topic === selectedTheory);
  ...
  return (
    <div className="page">
      <h1 className="page-title">📖 VARC Preparation</h1>

      {/* Theory Section */}
      <div className="theory-intro-box">
        <h2>📚 Learn VARC Concepts</h2>
        <div className="theory-topics-grid">
          {varcTheory.map((theory, idx) => (
            <div
              key={idx}
